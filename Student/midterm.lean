...
-- The axioms for additive actions define how transformations (specifically additive ones) can be applied
-- from elements of a certain type (G) to type (P) and ensure that they uphold the structure of G since
-- its an additive monoid.
...
instance : AddAction Rotation State := {
    ...
    | r0, r120, s0 => sorry
    | r0, r0, _ => sorry
    | r120, r120, s120 => sorry
    | r120, r120, s240 => sorry
    | r120, r240, s0 => sorry
    | r120, r240, s120 => sorry
    | r120, r240, s240 => sorry
    | r240, r120, s0 => sorry
    | r240, r120, s120 => sorry
    | r240, r120, s240 => sorry
    | r240, r240, s0 => sorry
    | r240, r240, s120 => sorry
    | r240, r240, s240 => sorry
  }
